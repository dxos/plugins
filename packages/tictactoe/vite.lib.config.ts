...
const entry = Object.fromEntries(
  [...Object.values<any>(pkg.exports), ...Object.values<any>(pkg.imports)].flatMap((value) => {
    // Skip non-object entries (e.g. the PLUGIN.mdl file reference string).
    if (typeof value !== 'object' || !value.source) {
      return [];
    }
    return [[entryName(value.source), value.source]];
  }),
);
